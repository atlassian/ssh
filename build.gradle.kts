...
publishing {
    val publication = publications.create("mavenJava", MavenPublication::class.java) {
        pom {
            scm {
                url.set("https://bitbucket.org/atlassian/ssh")
                connection.set("scm:git:git@bitbucket.org:atlassian/ssh.git")
                developerConnection.set("scm:git:git@bitbucket.org:atlassian/ssh.git")
            }
        }
    }
